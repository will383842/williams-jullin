...
import {
  ArrowRight, MapPin, Calendar, ExternalLink, Heart, Coffee, Lightbulb,
  Users, Quote, Star, TrendingUp, Plane, Building, Globe
} from 'lucide-react';
...
const MyStory: React.FC<MyStoryProps> = ({ navigate }) => {
  ...
  // ---- SEO & JSON-LD entièrement i18n ----
  useEffect(() => {
    // Title + meta description
    document.title = t('story.seo.title');
    const metaDescription = document.querySelector('meta[name="description"]');
    if (metaDescription) {
      metaDescription.setAttribute('content', t('story.seo.description'));
    }

    // JSON-LD (localisé)
    const keywords = (t('story.seo.keywords', { returnObjects: true }) as string[]) || [];
    const about = (t('story.seo.about', { returnObjects: true }) as Array<{ name: string; description: string }>) || [];

    const storyStructuredData = {
      '@context': 'https://schema.org',
      '@type': 'Article',
      'inLanguage': i18n.language,
      'headline': t('story.seo.headline'),
      ...
      'articleSection': t('story.seo.article_section'),
      'keywords': keywords,
      'about': about.map(a => ({ '@type': 'Thing', ...a }))
    };
  ...
  const personalValues = [
    {
      ...
      title: t('story.values.items.build.title'),
      description: t('story.values.items.build.subtitle'),
      story: t('story.values.items.build.bubble')
    },
    {
      icon: <Heart className="h-6 w-6" />,
      title: t('story.values.items.resilience.title'),
      description: t('story.values.items.resilience.subtitle'),
      story: t('story.values.items.resilience.bubble')
    },
    {
      icon: <Globe className="h-6 w-6" />,
      title: t('story.values.items.connection.title'),
      description: t('story.values.items.connection.subtitle'),
      story: t('story.values.items.connection.bubble')
    },
    {
      icon: <Lightbulb className="h-6 w-6" />,
      title: t('story.values.items.innovation.title'),
      description: t('story.values.items.innovation.subtitle'),
      story: t('story.values.items.innovation.bubble')
    }
  ];
          ...
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-12 lg:mb-20">
              <div className="inline-flex items-center space-x-2 bg-slate-100 text-slate-600 px-3 py-1.5 lg:px-4 lg:py-2 rounded-full text-sm font-medium mb-6 lg:mb-8">
                ...
                <span>{t('story.timeline.ribbon')}</span>
              </div>
                ...
                >
                  ...
                  <div className="hidden lg:grid lg:grid-cols-12 gap-8 items-center">
                    ...
                    <div className="lg:col-span-9">
                      <div
                        className={`bg-white rounded-2xl p-8 shadow-lg border border-slate-100 transition-all duration-300 ${
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-16 items-center mb-12 lg:mb-16">
              <div className="space-y-4 lg:space-y-6">
                ...
                <div className="space-y-3 lg:space-y-4 text-base lg:text-lg text-slate-600">
                  <p>{t('story.expatriation.shock_paragraph_1')}</p>
                  <p>{t('story.expatriation.shock_paragraph_2')}</p>
                </div>
              </div>

              {/* Carte mission (désormais i18n) */}
              <div className="relative mt-6 lg:mt-0">
                <div className="bg-gradient-to-br from-blue-500 to-blue-600 rounded-2xl lg:rounded-3xl p-8 lg:p-12 text-white text-center shadow-2xl">
                  <div className="space-y-4 lg:space-y-6">
                    ...
                    <h4 className="text-xl lg:text-2xl font-bold">{t('story.mission.title')}</h4>
                  ...
                  <div className="p-6 lg:p-8 space-y-6">
                    <div className="space-y-4 lg:space-y-6">
                      <div className="flex items-start space-x-3 lg:space-x-4">
                        ...
                        <div>
                          <h4 className="font-bold text-slate-900 mb-2 text-sm lg:text-base">
                            {t('story.platforms.sos.feature_1_title')}
                          </h4>
                          <p className="text-slate-600 text-sm lg:text-base">
                            {t('story.platforms.sos.feature_1_desc')}
                          </p>
                        </div>
                      </div>
                      ...
                      <div className="flex items-start space-x-3 lg:space-x-4">
                        ...
                        <div>
                          <h4 className="font-bold text-slate-900 mb-2 text-sm lg:text-base">
                            {t('story.platforms.sos.feature_2_title')}
                          </h4>
                          <p className="text-slate-600 text-sm lg:text-base">
                            {t('story.platforms.sos.feature_2_desc')}
                          </p>
                        </div>
                      </div>
                    </div>
                  ...
                  <div className="p-6 lg:p-8 space-y-6">
                    <div className="space-y-4 lg:space-y-6">
                      <div className="flex items-start space-x-3 lg:space-x-4">
                        ...
                        <div>
                          <h4 className="font-bold text-slate-900 mb-2 text-sm lg:text-base">
                            {t('story.platforms.ulixai.feature_1_title')}
                          </h4>
                          <p className="text-slate-600 text-sm lg:text-base">
                            {t('story.platforms.ulixai.feature_1_desc')}
                          </p>
                        </div>
                      </div>
                      ...
                      <div className="flex items-start space-x-3 lg:space-x-4">
                        ...
                        <div>
                          <h4 className="font-bold text-slate-900 mb-2 text-sm lg:text-base">
                            {t('story.platforms.ulixai.feature_2_title')}
                          </h4>
                          <p className="text-slate-600 text-sm lg:text-base">
                            {t('story.platforms.ulixai.feature_2_desc')}
                          </p>
                        </div>
                      </div>
                    </div>
                    ...
                    <div className="flex flex-col sm:flex-row items-start space-y-4 sm:space-y-0 sm:space-x-6">
                      ...
                      <div className="flex-1 space-y-3 lg:space-y-4">
                        ...
                        <div className="bg-blue-50 rounded-xl lg:rounded-2xl p-3 lg:p-4 border-l-4 border-blue-200">
                          <p className="text-blue-700 text-sm font-medium italic">💭 {value.story}</p>
                        </div>
                      </div>
                    </div>
                  </div>
          ...
          <div className="max-w-4xl mx-auto text-center text-white">
            <div className="space-y-6 lg:space-y-8">
              ...
              <div className="pt-6 lg:pt-8">
                <p className="text-slate-400 text-sm">{t('story.cta.connect')}</p>
              </div>
            </div>
          </div>
        </div>
